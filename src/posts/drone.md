...
excerpt: "Ever wondered what birds see? Or how to spend 300$ to the wind."
---
...
3. Press the button that you hopefully set up for locating your drone, and it will start beeping cheerfully with all four motors or a built-in beeper (if it has one).
